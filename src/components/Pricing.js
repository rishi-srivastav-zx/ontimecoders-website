              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-xl text-white placeholder-white/30 focus:outline-none focus:border-blue-500 focus:bg-white/10 transition-all resize-none"
  ...
  return (
    <div>
      ...
      <input
        ...
        className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-xl text-white placeholder-white/30 focus:outline-none focus:border-blue-500 focus:bg-white/10 transition-all"
...
const indianPlans = [
  {
    ...
    highlighted: false,
    description:
      "Perfect for small businesses and personal brands starting their digital journey.",
    features: [
      "5 Pages Website",
  ...
  },
  {
    ...
    highlighted: true,
    description:
      "Ideal for growing startups and SMEs ready to scale their online presence.",
    features: [
      "15 Pages Website",
      "Custom UI/UX Design",
      "Advanced SEO + Schema",
  ...
  },
  {
    ...
    highlighted: false,
    description:
      "Enterprise-grade solutions for established businesses demanding excellence.",
    features: [
      "2500 pages website",
    ...
    <section className="relative py-24 lg:py-32 overflow-hidden min-h-screen">
      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-20">
          ...
          >
            Transparent pricing built for Indian startups, SMEs, and growing
            brands. No hidden fees. No surprises.
          </motion.p>
        </div>
        ...
        >
          ...
          <div className="relative">
            ...
            <p className="text-white/50 mb-8 max-w-xl mx-auto">
              Book a free 30-minute consultation with our team. We'll analyse
              your needs and recommend the perfect solution.
            </p>
            <motion.button
              whileHover={{ scale: 1.02 }}
              whileTap={{ scale: 0.98 }}
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mt-16 text-center bg-white/5 backdrop-blur-xl p-10 rounded-[3rem] max-w-3xl mx-auto border border-white/10">
            ...
            <p className="text-white/60 mb-8">
              Have something unique in mind? We build tailored digital systems
