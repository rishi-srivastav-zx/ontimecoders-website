...
function FlipCard({ service, index, onQuoteClick }) {
  ...
  return (
    <div
      className="relative h-[420px] perspective-1000 group cursor-pointer"
...
export default function Services({ onPlanSelect }) {
  ...
  return (
    <section id="services" className="sm:py-32 p-4 px-6">
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <button
            ...
            className="px-8 py-4 bg-white/5 border border-white/10 rounded-full text-white font-semibold hover:bg-white/10 hover:border-blue-500/30 transition-all duration-300 flex items-center gap-2 mx-auto group"
          >
